...
Pada project ini, eager loading digunakan pada `MahasiswaController` melalui `Mahasiswa::with('matakuliahs')`. Dengan cara tersebut, relasi mata kuliah diambil lebih awal dengan query yang lebih efisien sehingga masalah N plus 1 dapat dikurangi.